...
# Complete CSS override using a direct external web image URL for the cursor
st.markdown(
    """
    <style>
    /* Absolute Global Overrides targeting every layer using a hosted periwinkle cursor image */
    html, body, .stApp, [data-testid="stAppViewContainer"], [data-testid="stAppViewContainer"] * {
        cursor: url("https://r2.dev") 16 16, auto !important;
    }
    
    /* Interactive Hover element pointers - switches style on buttons */
    a, button, .btn-link, [role="button"], a * {
        cursor: url("https://r2.dev") 16 16, pointer !important;
    }
